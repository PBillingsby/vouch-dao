        ...
        <div className="pb-12">
          <div className="text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-left text-lg text-gray-600 bg-clip-text" data-aos="zoom-y-out" data-aos-delay="150">VouchDAO is community owned and operated. <a style={{ color: '#6495ED' }} href="https://twitter.com/vouchdao" target="_blank">Join us.</a></p>
            </div>
          </div>
        </div>
      </div>
